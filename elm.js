...
var _user$project$Counter$init = function (i) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		i,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$Counter$view = function (count) {
	return A2(
...
var _user$project$Counter$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$Counter$init(0),
			view: _user$project$Counter$view,
			update: _user$project$Counter$update,
			subscriptions: _user$project$Counter$subscriptions
		})
};
